...
export const THEME_HEADER = ' ❦ theme #1 for the Quantum WordPress CMS'
export const INTRO_TEXT = "I'm Shaun a Creative Developer from the UK. I build websites & applications with a focus on design and performance. I'm currently avaiable for hire, so if you have a project in mind:"
export const INTRO_TEXT2 = 'You can find them on my GitHub.'
export const FOOTER_BTN_TEXT = 'HIRE ME'
