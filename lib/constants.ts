...
export const SITE_BANNER_TEXT = '🖖 Greetings | This theme is a beta test for a new product under active development: '
...
export const INTRO_TEXT = "I'm Shaun a Creative Developer from the UK. I build websites & applications with a focus on design, performance and measurability. React and WordPress are my weapons of choice. I'm avaiable for hire, so if you have a project in mind:"
...
export const FOOTER_TEXT2 = 'OF THE EVOLVED WEB'
export const FOOTER_BTN_TEXT = 'HIRE ME'
export const FOOTER_BTN_LINK = 'mailto:hi@primitivedigital.uk'
