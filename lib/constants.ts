...
export const SITE_BANNER_TEXT = '🖖 Greetings, this site is prototype for a low code CMS: '
...
export const PAGE_HEADER_TEXT = 'Latest Articles'
export const PAGE_HEADER_CTA = 'Get in Touch.'
