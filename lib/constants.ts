export const GITHUB_REPO = 'https://github.com/primitive/quantum-wordpress'
...
export const SITE_BANNER_TEXT = '🖖 Greetings, get your Minimum Viable Product: '
export const SITE_BANNER_LINK = 'https://sknow.it/posts/next-generation-eco-websites/'
export const SITE_BANNER_LINK_TEXT = 'Discover More'
export const THEME_NAME = 'Built with'
export const THEME_HEADER = ' ❦ Quantum WordPress'
export const INTRO_TEXT = 'We are a web and software development company specialised in building digital products & growing startups.'
export const INTRO_TEXT1 = "Creative Development from the heart of Yorkshire. We build “proper good” websites & applications with a focus on design, performance, measurability and value. If you want to a new website or app then:"
export const INTRO_TEXT2 = ''
export const INTRO_CTA = 'Get in Touch.'
export const INTRO_CTA_LINK = '/contact'
export const FOOTER_HEADER = 'SUBLIME DESIGN'
export const FOOTER_TEXT = 'TO COMPLIMENT THE DEVELOPMENT'
export const FOOTER_TEXT2 = 'OF AN EVOLVED WEB'
export const FOOTER_BTN_TEXT = 'CONTACT US'
export const FOOTER_BTN_LINK = '/contact'
export const FOOTER_BTN2_TEXT = 'Request a Feature'
export const FOOTER_BTN2_LINK = 'https://github.com/primitive/quantum-wordpress/issues/new?assignees=&labels=&template=feature_request.md&title=NEW+FEATURE+REQUEST'
export const FOOTER_COLOPHON= '© SKNOW.IT 2023 | All rights reserved.'
...
export const MORE_POSTS_HEADER= 'Discover More'
...
export const PAGE_HEADER_CTA_LINK = '/posts/next-generation-eco-websites'
